...
# UDP_IP = "0.0.0.0"
# UDP_IP = "127.0.0.1"
UDP_IP = "192.168.43.174"
# UDP_IP = "192.168.11.99"
KACHAKA_IP = "192.168.11.11"
TCP_HOST_IP = "0.0.0.0"
UDP_PORT = 50000
TCP_PORT = 50001
# MARKER_LENGTH = 0.084  # [m]
MARKER_LENGTH = 0.042  # [m]
CAMERA_ID = 3
...
camera_configs = {
    ...
    3: {
        "CAM_HEIGHT": 768,
        "CAM_WIDTH": 1024,
        # RMS =  1.044382142923972
        "CAMERA_MATRIX": np.array(
            [
                [830.70767735, 0, 501.51075532],
                [0, 836.24319365, 461.91358327],
                [0, 0, 1],
            ]
        ),
        "DISTORTION_COEFF": np.array(
            [-0.12456083, 0.74496212, 0.00954336, -0.0045896, -1.12427955]
        ),
    },
    # 75 3264x2448
